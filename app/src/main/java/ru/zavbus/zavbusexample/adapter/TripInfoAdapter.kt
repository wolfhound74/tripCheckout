...
class TripInfoAdapter(
        ...
        val actions: MutableList<Map<String, String>>) : BaseAdapter() {

    constructor(context: Context, list: MutableList<Map<String, String>>) : this(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val action: Map<String, String> = actions.get(position)
